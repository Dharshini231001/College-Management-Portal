...
<html lang="en">
	...
	while ($row=mysqli_fetch_array($run)) {
		...
		<div class="container  mt-1 border border-secondary mb-1">
				...
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h5>aadhar:</h5> <?php echo $row['aadhar']  ?><br><br>
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>NATA Mark</h5> <?php echo $row['nata_mark']  ?></div>
			...
			<div class="row pt-3">
				...
				<div class="col-md-4"><h5>Regulation:</h5> <?php echo $row['session']  ?></div>
			</div>
			<div class="row pt-3">
				...
				<div class="col-md-4"><h5>B Form:</h5> <?php echo $row['hsc_percentage']  ?></div>
			</div>
			<div class="row pt-3">
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>SSLC Start Date:</h5> <?php echo $row['sslc_start_date']  ?></div>
				<div class="col-md-4"><h5>SSLC Complition Date:</h5> <?php echo $row['sslc_complition_date']  ?></div>
				<div class="col-md-4"><h5>SSLC Certificate:</h5> <?php echo $row['sslc_certificate']  ?></div>
			</div>
			<div class="row pt-3">
				<div class="col-md-4"><h5>HSC Start Date:</h5> <?php echo $row['hsc_start_date']  ?></div>
				<div class="col-md-4"><h5>HSC Complition Date:</h5> <?php echo $row['hsc_complition_date']  ?></div>
				<div class="col-md-4"><h5>HSC Certificate:</h5> <?php echo $row['hsc_certificate']  ?></div>
			</div>
		</div>
	<?php } ?>
</body>
