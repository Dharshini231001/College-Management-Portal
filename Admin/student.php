...
<?php  
 	if (isset($_POST['btn_save'])) {
		...
		$permanent_address=$_POST["permanent_address"];
 		...
 		$sslc_start_date=$_POST["sslc_start_date"];
 		
 		$sslc_complition_date=$_POST["sslc_complition_date"];
 		
 		$hsc_start_date=$_POST["hsc_start_date"];
 		
 		$hsc_complition_date=$_POST["hsc_complition_date"];
...
// *****************************************Images upload code starts here********************************************************** 
		...
		$hsc_certificate = $_FILES['hsc_certificate']['name'];$tmp_name=$_FILES['hsc_certificate']['tmp_name'];$path = "images/".$hsc_certificate;move_uploaded_file($tmp_name, $path);


// *****************************************Images upload code end here********************************************************** 

 		$query="Insert into student_info(roll_no,first_name,middle_name,last_name,father_name,email,mobile_no,course_code,session,profile_image,prospectus_issued,paid_fees,hsc_percentage,nata_mark,application_status,aadhar,dob,gender,permanent_address,current_address,place_of_birth,sslc_start_date,sslc_complition_date,sslc_certificate,hsc_start_date,hsc_complition_date,hsc_certificate)values('$roll_no','$first_name','$middle_name','$last_name','$father_name','$email','$mobile_no','$course_code','$session','$profile_image','$prospectus_issued','$paid_fees','$hsc_percentage','$nata_mark','$application_status','$aadhar','$dob','$gender','$permanent_address','$current_address','$place_of_birth','$sslc_start_date','$sslc_complition_date','$sslc_certificate','$hsc_start_date','$hsc_complition_date','$hsc_certificate')";
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h4 class="mr-5">Student Management : </h4>
							        ...
							        <form action="student.php" method="POST" enctype="multipart/form-data">
										<div class="row mt-3">
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Select Regulation:</label>
								  		...
								  		<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Paid Fees</label>
												    <select class="browser-default custom-select" name="paid_fees">
													  <option>Select Option</option>
													  <option value="Yes">Yes</option>
													  <option value="No">No</option>
													</select>
											...
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">HSC Percentage</label>
												    <input type="text" name="hsc_percentage" class="form-control">
											    </div>
											</div>
								  		</div>
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">NATA Mark </label>
											        <input type="text" name="nata_mark" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    ...
												    <select class="browser-default custom-select" name="application_status">
													  ...
													  <option value="Not Approved">Not Admitted</option>
													</select>
											    </div>
											</div>
											<div class="col-md-4">
								  		...
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">SSLC Start Date: </label>
											        <input type="date" name="sslc_start_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">SSLC Complition Date:</label>
												    <input type="date" name="sslc_complition_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Upload SSLC Certificate:</label>
												    <input type="file" name="sslc_certificate" class="form-control" value="there is no image" >
											    </div>
											</div>
								  		</div>
								  		<div class="row">
											<div class="col-md-4">
											    <div class="form-group">
											        <label for="exampleInputEmail1">HSC Start Date: </label>
											        <input type="date" name="hsc_start_date" class="form-control" value="0">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">HSC Complition Date:</label>
												    <input type="date" name="hsc_complition_date" class="form-control">
											    </div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
												    <label for="exampleInputPassword1">Upload HSC Certificate:</label>
												    <input type="file" value="C:/xampp/htdocs/Imperial University/Images/no-image-available.jpg" name="hsc_certificate" class="form-control" >
											    </div>
											</div>
								  		</div>
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							...
							<table class="w-100 table-elements mb-5 table-three-tr text-center" cellpadding="10">
								...
								<?php 
								$query="select first_name,middle_name,admission_date,last_name,current_address,session,roll_no,hsc_percentage ,profile_image,course_code from student_info";
								$run=mysqli_query($con,$query);
								while($row=mysqli_fetch_array($run)) {?>
									<tr>
