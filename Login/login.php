...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	<body class="login-background">
		<?php include('../common/common-header.php') ?><br>
        <div class="login-div mt-3 rounded">
            <div class="logo-div text-center">
                <img src="../images/login.jpeg" alt="" class="align-items-center" width="100" height="100">
            </div>
            <div class="login-padding">
                ...
                <form class="p-1" action="login.php" method="POST">
                    ...
                    <div class="form-group text-center mb-3 mt-4">
                        <input type="submit" name="btnlogin" value="LOGIN" class="btn btn-white pl-5 pr-5 " style="color: white; border:1px solid white;">
                    </div>
                </form>
            </div>
        </div>
